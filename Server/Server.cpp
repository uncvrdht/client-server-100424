...
int main()
{
    ...
    do {
        ...
        if (iResult > 0) {
            ...
            const char* answer;
            string temp;
            string help = "C\n0 - Kyiv\t 1 - Kharkiv\t 2 - Odessa\t 3 - Lviv\t 4 - Dnipro\t 5 - Zaporizhzhia\t 6 - Vinnytsia\t 7 - Mykolaiv\t 8 - Sumy\t 9 - Chernihiv\n";
            switch (atoi(message))
            {
            case 0:
                temp += "Kyiv - " + to_string((int)(rand() % 15+5)) + help;
                break;
            case 1:
                temp += "Kharkiv - " + to_string((int)(rand() % 15 + 5)) + help;
                break;
            case 2:
                temp += "Odessa - " + to_string((int)(rand() % 15 + 5)) + help;
                break;
            case 3:
                temp += "Lviv - " + to_string((int)(rand() % 15 + 5)) + help;
                break;
            case 4:
                temp += "Dnipro - " + to_string((int)(rand() % 15 + 5)) + help;
                break;
            case 5:
                temp += "Zaporizhzhia - " + to_string((int)(rand() % 15 + 5)) + help;
                break;
            case 6:
                temp += "Vinnytsia - " + to_string((int)(rand() % 15 + 5)) + help;
                break;
            case 7:
                temp += "Mykolaiv - " + to_string((int)(rand() % 15 + 5)) + help;
                break;
            case 8:
                temp += "Sumy - " + to_string((int)(rand() % 15 + 5)) + help;
                break;
            case 9:
                temp += "Chernihiv - " + to_string((int)(rand() % 15 + 5)) + help;
                break;
            default:
                break;
            }
